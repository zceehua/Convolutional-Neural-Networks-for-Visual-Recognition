...
class TwoLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
    ...
    ############################################################################
	# attention to how to initialize w and b
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
	#calculate loss,add L2 of w1/w2 respectively!!!!!
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(1, self.num_layers+1):
	  ...
	  #for hidden layer--affine-->batchnormalization-->relu-->dropout
      if i == self.num_layers:
        scores, cache = affine_forward(scores, self.params[W_name], self.params[b_name])
      else:
        if self.use_batchnorm:
          scores, self.batchnorm_cache[batchnorm_name] = affine_norm_relu_forward(scores, self.params[W_name], self.params[b_name], self.params[gamma_name], self.params[beta_name], self.bn_params[i-1])
    ...
    for i in range(self.num_layers, 0, -1):
      ...
      #in the reverse order of forward path,dropout-->relu-->batchnormalization-->affine
      if i == self.num_layers:
        ...
        if self.use_batchnorm:
          der, grads[W_name], grads[b_name],grads[gamma_name], grads[beta_name] = affine_norm_relu_backward(der, self.batchnorm_cache[batchnorm_name])
		else:
