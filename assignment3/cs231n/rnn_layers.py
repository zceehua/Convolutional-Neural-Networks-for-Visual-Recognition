...
def word_embedding_forward(x, W):
  ...
  ##############################################################################
  #N, T, V, D = 2, 4, 5, 3,x = np.asarray([[0, 3, 1, 2], [2, 1, 0, 3]]),W = np.linspace(0, 1, num=V*D).reshape(V, D)
  #0 correspond to line 0 of W,3correspond to line 4 of W,1 to line 2 of W.....,output with dim(2,4,3)
  out = W[x, :]
  cache = x, W
  ##############################################################################
  #                               END OF YOUR CODE                             #
